...
Anonymous functions that can receive arguments, and be passed on as arguments to other functions.
...
The type of `x` is inferred by the compiler to be `String` based on its first usage (during COMPILE TIME), soon:
